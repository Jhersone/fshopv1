        ...
        <div className="max-w-[990px] mx-auto px-4 py-3 flex items-center justify-between gap-3">
          ...
          <div className="min-w-0 flex flex-col text-white">
            ...
            <div className="text-[17px] mt-0.5">
              Total: <span className="font-bold text-[#FFFF00]">{priceText}</span>
            </div>
          </div>
          ...
          <button
            type="button"
            onClick={onClick}
            className="flex-shrink-0 w-[180px] bg-[#ffff00] text-black font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-2 text-base shadow-lg transition"
